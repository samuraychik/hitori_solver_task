...
class HitoriBoardTestCase(unittest.TestCase):
    ...
    def test_init_correctly(self):
        self.board = hb.HitoriBoard(3, 2, [1, 2, 3,
                                           4, 5, 6])
    ...
    def test_get_cell(self):
        self.board = hb.HitoriBoard(2, 2, [1, 2,
                                           3, 4])
    ...
    def test_get_diagonal_repeats(self):
        ...
        self.assertCountEqual(self.board.get_diagonal_repeats_from_cell(
            self.board._board[1, 1]), excepted)
